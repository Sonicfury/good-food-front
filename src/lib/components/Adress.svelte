...
<div class="flex flex-col m-10">
  {#if isAdressForm}
        ...
        {#each adress as item}
          <div class="space-y-4 m-2">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
              ...
              <button on:click="{deleteAdress(item.id)}" class=" btn btn-outline  btn-primary text-white m-2">
                Supprimer
              </button>
              <button on:click="{updateAdress(item)}" class=" btn btn-outline  btn-success text-white m-2">
                Modifier
              </button>
            </div>
          </div>
    ...
    <button on:click="{showAdressForm}" class=" btn btn-outline  btn-primary text-white mt-10">
      Ajouter une adresse
    </button>
  {:else}
    <div class="flex flex-col">
      ...
      <button on:click="{saveAdress}" class="color-primary btn btn-outline font-semibold py-2 px-4 rounded-lg mt-4">
        Enregistrer
      </button>
    </div>
  {/if}
