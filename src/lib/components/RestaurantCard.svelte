<script lang="ts">
  ...
  export let restaurantsList: Restaurant
</script>
...
<div class="flex justify-center m-10">
  <div class="card w-120 border-slate-300 border text-neutral-content">
    <div class="card-body p-6 flex-row">
      ...
      />
      <div class="ml-10">
        <h3 class="card-title">{restaurantsList.name}</h3>
        <h4>{restaurantsList.city}</h4>
        <p>{restaurantsList.address}</p>
        <p>{restaurantsList.primaryPhone}</p>
      </div>
    </div>
