...
<div class="fixed bottom-4 transform inline-flex  mx-auto justify-between bg-white w-full bottom-0">
    <a
        aria-current="page"
    ...
    <a class="relative inline-flex flex-col items-center text-xs font-medium text-white py-3 px-6 flex-grow">
